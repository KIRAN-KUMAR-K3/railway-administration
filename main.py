...
def train_functions():
        ...
        if auth_option == "Login":
            ...
            if st.sidebar.button("Register"):
                if new_username and new_password:
                    register(new_username, new_password, role)
                else:
    ...
    # Add functionality for authenticated users
        ...
        if st.session_state['role'] == 'admin':
            functions = st.sidebar.radio("Select Admin Functions", [
                "Add Train", "Delete Train", "View Trains", "Search Train", "View Seats"])
            ...
            functions = st.sidebar.radio("Select User Functions", ["Book Ticket", "Cancel Ticket", "View Seats"])
